...
import { fetchSingleEstoque } from "../api/ApiCollection";
import {
  LineChart,
  Line,
  XAxis,
...
const Estoque = () => {
  ...
  const { isLoading, isError, data, isSuccess } = useQuery({
    ...
    queryFn: () => fetchSingleEstoque(id),
    enabled: !!id,
  });

  React.useEffect(() => {
    if (isLoading) toast.loading("Carregando...", { id: "estoquesRead" });
    if (isError) toast.error("Erro ao carregar dados!", { id: "estoquesRead" });
    if (isSuccess)
      toast.success("Dados carregados com sucesso!", { id: "estoquesRead" });
  ...
  return (
    <div id="singleEstoques" className="w-full p-0 m-0">
      {isError && (
        <div className="text-center mt-10 text-red-500 font-semibold">
          Erro ao carregar o estoques.
        </div>
      )}
            ...
            <div className="w-full flex flex-col items-start gap-5">
              ...
              <div className="flex items-center gap-8 mb-4">
                <div className="flex flex-col items-start gap-1">
                  ...
                  <span className="font-normal text-base">Estoques</span>
                </div>
              </div>
