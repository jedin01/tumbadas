...
import { fetchSingleEntrada } from "../api/ApiCollection";
import {
  LineChart,
  Line,
  XAxis,
...
const Entrada = () => {
  ...
  const { isLoading, isError, data, isSuccess } = useQuery({
    ...
    queryFn: () => fetchSingleEntrada(id),
    enabled: !!id,
  });

  React.useEffect(() => {
    if (isLoading) toast.loading("Carregando...", { id: "entradasRead" });
    if (isError) toast.error("Erro ao carregar dados!", { id: "entradasRead" });
    if (isSuccess)
      toast.success("Dados carregados com sucesso!", { id: "entradasRead" });
  ...
  return (
    <div id="singleEntradas" className="w-full p-0 m-0">
      {isError && (
        <div className="text-center mt-10 text-red-500 font-semibold">
          Erro ao carregar o entradas.
        </div>
      )}
            ...
            <div className="w-full flex flex-col items-start gap-5">
              ...
              <div className="flex items-center gap-8 mb-4">
                <div className="flex flex-col items-start gap-1">
                  ...
                  <span className="font-normal text-base">Entradas</span>
                </div>
              </div>
